...
public class RunnerInterface extends MainInterface{
    ...
    public static Runner login() {
        ...
        while (repeat==1) {
            ...
            if (runner == null) {
                ...
                loginRunner = new Runner(runner.getID(),runner.getPassword(),runner.getRunnerName(),runner.getContact());
            }
        }
        return loginRunner;
    }
    ...
    public static void accessProfile(Runner runner){
        ...
        System.out.println(String.format("%-24s", "Vendor Password") + String.format("%24s", "*****"+runner.getPassword().substring(runner.getPassword().length()-3)));
        System.out.println();
